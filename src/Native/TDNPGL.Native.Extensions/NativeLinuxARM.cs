...
{
    internal class NativeLinuxARM : AbstractNative
    {
        static NativeLinuxARM()
        {
        }
        [DllImport("arm\\libtdnpgl.so", EntryPoint = "AABB_IsPointOver", CallingConvention = CallingConvention.Cdecl)]
